                            ...
                            <div class="card bg-info text-white text-center mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-secondary " data-bs-toggle="modal"
                                        data-bs-target="#modal1" style="background-color: floralwhite; color:black">KLIK
                                        SAYA
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card bg-primary text-white text-center mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-secondary " data-bs-toggle="modal"
                                        data-bs-target="#modal2" style="background-color: floralwhite; color:black">KLIK
                                        SAYA
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card bg-warning text-white text-center mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-secondary " data-bs-toggle="modal"
                                        data-bs-target="#modal3" style="background-color: floralwhite; color:black">KLIK
                                        SAYA
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="card bg-success text-white text-center mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-secondary " data-bs-toggle="modal"
                                        data-bs-target="#modal4" style="background-color: floralwhite; color:black">KLIK
                                        SAYA
                                    </button>
                                </div>
                            </div>
