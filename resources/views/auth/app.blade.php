...
<body>
    ...
    <script src="{{ asset('fronend') }}/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/popper/popper.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/js/bootstrap.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/node-waves/node-waves.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/hammer/hammer.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/i18n/i18n.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/typeahead-js/typeahead.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/js/menu.js"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('fronend') }}/assets/vendor/libs/@form-validation/popular.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/@form-validation/bootstrap5.js"></script>
    <script src="{{ asset('fronend') }}/assets/vendor/libs/@form-validation/auto-focus.js"></script>

    <!-- Main JS -->
    <script src="{{ asset('fronend') }}/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="{{ asset('fronend') }}/assets/js/pages-auth.js"></script>
</body>
